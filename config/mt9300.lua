...
function load_fas(pid, pkg)
    ...
    then
        set_offset(-400000, -300000, -300000)
    ...
    then
        set_offset(-480000, -200000, -300000)
    elseif (pkg == "com.tencent.KiHan" )
    then
        set_offset(-400000, -300000, -250000)

...
function set_offset(policy0, policy4, policy8)
    set_policy_freq_offset(0, policy0)
    set_policy_freq_offset(4, policy4)
    set_policy_freq_offset(8, policy8)
end
...
function load_fas(pid, pkg)
    ...
    then
        set_offset(-300000, -300000, -250000)
    ...
    then
        set_offset(-400000, -400000, -350000)
     elseif (pkg == "com.tencent.tmgp.dfm")
    then
        set_offset(-550000, -450000, 0)

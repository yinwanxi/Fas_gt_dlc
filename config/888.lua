...
function load_fas(pid, pkg)
    ...
    then
        set_offset(-450000, -480000, 0)
    elseif (pkg == "com.netease.dwrg")
    then
        set_offset(-400000, -400000, -300000)

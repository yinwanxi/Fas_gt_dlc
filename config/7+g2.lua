...
function load_fas(pid, pkg)
    ...
    then
        set_offset(-500000, -650000, -350000)
     elseif (pkg == "com.tencent.tmgp.dfm")
    then
        set_offset(-550000, -650000, 0)
    elseif (pkg == "com.sofunny.Sausage" )
    then
        set_offset(-550000, -600000, 0)
    end
end

...
function set_offset(policy0, policy3, policy6)
    set_policy_freq_offset(0, policy0)
    set_policy_freq_offset(4, policy3)
    set_policy_freq_offset(6, policy6)
end
